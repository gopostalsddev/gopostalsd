...
const TermsPage = () => {
  return (
    <InformationalPageLayout
      ...
      subtitle="These terms govern use of the Uzima Prints website, customer accounts, online checkout, payment handling, and order fulfillment workflows for printing and shipping-related services. Effective date: August 17, 2026."
      ...
      sections={[
        ...
        },
        {
          ...
          body: 'Requests to change or cancel an order must be made as quickly as possible. Cancellations, production changes, and refunds are handled case by case at the discretion of Uzima Prints. Because print and fulfillment work may begin promptly after payment, the store may decline a cancellation or refund request depending on production status, shipment status, payment status, and the reason for the request.',
          bullets: [
        ...
        },
        {
          ...
          body: 'Once an order enters production or is handed off for shipment, changes may be limited or unavailable. Delivery estimates and tracking events depend on carriers and external vendors. Uzima Prints is not responsible for delays caused by customer-supplied errors, carrier disruptions, force majeure events, or third-party provider outages outside the store’s reasonable control. For shipping issues, the store may review damaged-order claims, but replacements, credits, or other resolutions remain subject to review.',
        },
        {
          heading: 'Support and disputes',
          body: 'If there is a problem with an order, contact Uzima Prints promptly and include the order number when available. The store may request supporting information before issuing a replacement, adjustment, or refund decision.',
          bullets: [
